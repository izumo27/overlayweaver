...
// ここから追加
public final class MLCommand implements Command<DHT<String>> {
	private final static String[] NAMES = {"ml"};

	public String[] getNames() { return NAMES; }

	public String getHelp() {
		return "ml [-status] <key> [<key> ...]";
	}
	...
	public boolean execute(ShellContext<DHT<String>> context) {
		...
		// parse the command line and queue ml requests

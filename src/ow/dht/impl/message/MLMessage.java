...
public final class MLMessage<V> extends Message {
	public final static String NAME = "ML";
	public final static boolean TO_BE_REPORTED = true;
	public final static Color COLOR = null;

	// message members
	public DHT.MLRequest<V>[] requests;
	public long ttl;
	public ByteArray hashedSecret;
//	public int numReplica;

	public MLMessage() { super(); }	// for Class#newInstance()

	public MLMessage(
			DHT.MLRequest<V>[] requests/*, long ttl, ByteArray hashedSecret, int numReplica*/) {
...
//		oos.writeInt(this.numReplica);
	...
	public void decodeContents(ObjectInputStream ois) throws IOException, ClassNotFoundException {
		this.requests = (DHT.MLRequest<V>[])ois.readObject();
